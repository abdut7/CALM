       ...
       b.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               mAuth.signInWithEmailAndPassword(u, p)
                       .addOnCompleteListener(stationsignin.this, new OnCompleteListener<AuthResult>() {
                           @Override
                           public void onComplete(@NonNull Task<AuthResult> task) {
                               if (task.isSuccessful()) {
                                   // Sign in success, update UI with the signed-in user's information
                                   Toast.makeText(stationsignin.this, "Succes", Toast.LENGTH_SHORT).show();
                                   ...
                                   Toast.makeText(stationsignin.this, "Authentication failed.",
...
//        SharedPreferences.Editor ed= sp.edit();
    ...
    {
        startActivity(new Intent(stationsignin.this,StationRegistration.class));
